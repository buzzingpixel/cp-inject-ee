...
name=($(jq -r '.name' cp_inject/addon.json));

# Get the software version
version=($(jq -r '.version' cp_inject/addon.json));
...
cp -r cp_inject localStorage/build/system/user/addons/cp_inject;
cp -r license.md localStorage/build/license.md;
cp -r license.md localStorage/build/system/user/addons/cp_inject/license.md;
